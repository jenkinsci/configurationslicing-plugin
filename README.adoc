...
image:https://ci.jenkins.io/buildStatus/icon?job=Plugins%2Fconfigurationslicing-plugin%2Fmaster[link='https://ci.jenkins.io/job/Plugins/job/configurationslicing-plugin/job/master/']
