...
public class TimerSliceStringSlicerTest extends HudsonTestCase {
    ...
    private void doTestTimerSliceStringSlicer(UnorderedStringSlicer slicer, AbstractTimerSliceSpec spec)
            throws Exception {
        ...
        AbstractProject project = accumulate(
                slicer,
                slice,
                spec,
                "p3",
    ...
    @SuppressWarnings("unchecked")
    private AbstractProject accumulate(
            UnorderedStringSlicer slicer,
            UnorderedStringSlice slice,
            AbstractTimerSliceSpec spec,
            String name,
            String chron)
            throws Exception {
